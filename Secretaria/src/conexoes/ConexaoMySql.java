...
public class ConexaoMySql {
    ...
    private String servidor = "localhost:3306"; //Servidor do BD
    private String nomeDoBanco = "escola"; //Nome do BD
    private String usuario = "root"; //Usuário do servidor
    private String senha = ""; // Senha do servidor
